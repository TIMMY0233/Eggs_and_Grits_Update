package net.dove.eggsandgrits.structures;

import com.mojang.serialization.Codec;
import com.mojang.serialization.MapCodec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.dove.eggsandgrits.EggsAndGritsStructures;
...
public class SkyStructures extends Structure {
    ...
    public static final MapCodec<SkyStructures> CODEC = RecordCodecBuilder.mapCodec(instance ->
            instance.group(SkyStructures.configCodecBuilder(instance),
                    ...
                    Codec.intRange(1, 250).fieldOf("max_distance_from_center").forGetter(structure -> structure.maxDistanceFromCenter),
    ...
    public StructureType<?> getType() {
        return EggsAndGritsStructures.SKY_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}

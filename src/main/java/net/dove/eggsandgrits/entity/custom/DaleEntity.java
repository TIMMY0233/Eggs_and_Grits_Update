...
public class DaleEntity extends AnimalEntity {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    private final ServerBossBar bossBar = new ServerBossBar(Text.literal("Dale Earnhardt"),
            BossBar.Color.BLUE, BossBar.Style.NOTCHED_10);

    public DaleEntity(EntityType<? extends AnimalEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new TemptGoal(this, 1.25D, Ingredient.ofItems(ModItems.WAFFLE), false));
    ...
    public @Nullable PassiveEntity createChild(ServerWorld world, PassiveEntity entity) {
        return ModEntities.DALE.create(world);
    }

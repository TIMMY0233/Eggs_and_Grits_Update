...
public class ModBiomes {
    public static final RegistryKey<Biome> TEST_BIOME = RegistryKey.of(RegistryKeys.BIOME, Identifier.of(EggsAndGrits.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(Registerable<Biome> context) {
        ...
        //entity spawns
        spawnBuilder.spawn(SpawnGroup.CREATURE, new SpawnSettings.SpawnEntry(ModEntities.ATTACK_HELICOPTER, 2, 3, 5));
